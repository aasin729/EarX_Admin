...
var Icon = (function () {
    ...
    return (
      ...
      (e.prototype.loadIcon = function () {
        ...
        if (!this.isServer && this.isVisible) {
          var t = this.getUrl();
          t &&
            getSvgContent(t).then(function (t) {
              e.svgContent = validateContent(e.doc, t, e.el['s-sc']);
            });
        }
        if (!this.ariaLabel) {
          var i = getName(this.name, this.mode, this.ios, this.md);
          i &&
            (this.ariaLabel = i
              .replace('ios-', '')
              .replace('md-', '')
      ...
      (e.prototype.getUrl = function () {
        ...
        return (
          e ||
          ((e = getName(this.name, this.mode, this.ios, this.md))
            ? this.getNamedUrl(e)
            : (e = getSrc(this.icon))
              ? e
              : (e = getName(this.icon, this.mode, this.ios, this.md))
                ? this.getNamedUrl(e)
                : null)
        );
      }),
  ...
  requests = new Map();
function getSvgContent(e) {
  var t = requests.get(e);
  return (
    t ||
...
function getSrc(e) {
  return 'string' == typeof e && (e = e.trim()).length > 0 && /(\/|\.)/.test(e)
    ? e
    : null;
}
function validateContent(e, t, i) {
  if (t) {
...
function isValid(e) {
  if (1 === e.nodeType) {
    ...
    for (t = 0; t < e.childNodes.length; t++)
      if (!isValid(e.childNodes[t])) return !1;
  }
  return !0;
}
function createColorClasses(e) {
  var t;
  return e ? (((t = { 'ion-color': !0 })['ion-color-' + e] = !0), t) : null;
}
