...
!(function (t, e) {
  ...
  function yt(t, e) {
    ...
    if (0 === t.offset) {
      ...
      n = bt(t.node)
        ? it((o = t.node.childNodes[t.offset - 1]))
  ...
  function kt(t, e) {
    ...
    if (it(t.node) === t.offset) {
      ...
      n = bt(t.node)
        ...
        : ((o = t.node), e ? it(t.node) : t.offset + 1);
    return { node: o, offset: n };
  }
  function Ct(t, e) {
  ...
  var Ot,
    ...
    jt = (function () {
      ...
      return (
        ...
        (t.prototype.resizehref = function (t, e, o) {
          var n;
          if (o) {
            var i = t.y / t.x,
              r = e.data('ratio');
  ...
  var Vt = (function () {
    ...
    _t = (function () {
      ...
      return (
        (t.prototype.resizehref = function (t) {
        ...
        (t.prototype.createVideoNode = function (t) {
          ...
          if (o && 11 === o[1].length) {
            ...
            e = k(
              ...
              .attr(
                'src',
                'http://v.qq.com/iframe/player.html?vid=' + y + '&amp;auhref=0',
              );
          } else {
            if (!(d || u || h)) return !1;
            e = k('<video controls>')
