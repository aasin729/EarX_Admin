/*! For license information please see summernote.min.js.LICENSE.txt */ !(function (
  t,
  e,
) {
              ...
              value: function () {
                ...
                this.$editable
                  ...
                  this.options.disableGrammar &&
                    this.$editable.attr('data-bs-gramm', !1),
            ...
            e.fade && t.addClass('fade'),
              ...
              t.html(
                [
                  ...
                  e.title
                    ? '<div class="modal-header"><h6 class="modal-title">' +
                      e.title +
                      '</h6> <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" aria-hidden="true">&times;</button></div>'
                    : '',
