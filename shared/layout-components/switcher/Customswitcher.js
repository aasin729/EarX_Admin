                  ...
                  <Modal className="buynow buynow-btn" size="lg" show={Basic}>
                    <Modal.Body className="p-0 overflow-hidden">
                      <div
                        ...
                        style={{ backgroundImage: `url(${img16.src})` }}
                      >
                        <h3
                          className=" text-center mb-4 text-white licenses-colour"
                          style={{ zIndex: 1 }}
                        >
                          Licenses
                        </h3>
                          ...
                          <div className="col-sm-10 col-md-8 col-xl-5 col-lg-5">
                            <div className="card  border-0 regular-license">
                              <div
                                ...
                                style={{ backgroundImage: `url(${img14.src})` }}
                              >
                                    ...
                                    <Dropdown>
                                      ...
                                      >
                                        <Dropdown.Item
                                          ...
                                          target="_blank"
                                          href="https://1.envato.market/Vy1YaO"
                                        >
                                          <div>
                                            <p className="tx-14 mb-0 lh-xs font-bold">
                                              Buy Now
                                            </p>
                                        ...
                                        <Dropdown.Item
                                          className="px-3"
                                          target="_blank"
                                          href="https://1.envato.market/ORjnjN"
                                        >
                                          <div>
                                            <p className="tx-14 mb-0 lh-xs font-bold">
                                              Buy Now
                          ...
                          <div className="col-sm-10 col-md-8 col-xl-5 col-lg-5">
                            <div className="card border-0 ">
                              <div
                                ...
                                style={{ backgroundImage: `url(${img15.src})` }}
                              >
                                <div className="text-white">
                                  <img
                                    src={moneybag.src}
                                    ...
                                    <Dropdown>
                                      ...
                                      >
                                        <Dropdown.Item
                                          className="border-bottom px-3"
                                          target="_blank"
                                          href="https://1.envato.market/n1mEkA"
                                        >
                                          <div>
                                            <p className="tx-14 mb-0 lh-xs font-bold">
                                              Buy Now
                                        ...
                                        <Dropdown.Item
                                          className="px-3"
                                          target="_blank"
                                          href="https://1.envato.market/3PGjGB"
                                        >
                                          <div>
                                            <p className="tx-14 mb-0 lh-xs font-bold">
                                              Buy Now
