                        ...
                        <div className="list-group-item d-flex  align-items-center">
                          <div className="me-3">
                            <img
                              alt=""
                              className="avatar avatar-lg brround cover-image"
                              src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/img/faces/1.jpg`}
                            />
                          </div>
                          <div>
                        ...
                        <div className="list-group-item d-flex  align-items-center">
                          <div className="me-3">
                            <img
                              alt=""
                              className="avatar avatar-lg brround cover-image"
                              src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/img/faces/8.jpg`}
                            />
                            <span className="avatar-status bg-success"></span>
                          </div>
                          <div>
                        ...
                        <div className="list-group-item d-flex  align-items-center">
                          <div className="me-3">
                            <img
                              alt=""
                              className="avatar avatar-lg brround cover-image"
                              src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/img/faces/11.jpg`}
                            />
                          </div>
                          <div>
                            <strong>Anthony</strong> New product Launching...
                        ...
                        <div className="list-group-item d-flex  align-items-center">
                          <div className="me-3">
                            <img
                              alt=""
                              className="avatar avatar-lg brround cover-image"
                              src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/img/faces/6.jpg`}
                            />
                            <span className="avatar-status bg-success"></span>
                          </div>
                          <div>
                        ...
                        <div className="list-group-item d-flex  align-items-center">
                          <div className="me-2">
                            <img
                              alt=""
                              className="avatar avatar-md brround cover-image"
                              src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/img/faces/10.jpg`}
                            />
                            <span className="avatar-status bg-success"></span>
                          </div>
                          <div className="">
                        ...
                        <div className="list-group-item d-flex  align-items-center">
                          <div className="me-2">
                            <img
                              alt=""
                              className="avatar avatar-md brround cover-image"
                              src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/img/faces/13.jpg`}
                            />
                          </div>
                          <div className="">
                            <div
                        ...
                        <div className="list-group-item d-flex  align-items-center">
                          <div className="me-2">
                            <img
                              alt=""
                              className="avatar avatar-md brround cover-image"
                              src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/img/faces/4.jpg`}
                            />
                          </div>
                          <div className="">
                            <div
                        ...
                        <div className="list-group-item d-flex  align-items-center">
                          <div className="me-2">
                            <img
                              alt=""
                              className="avatar avatar-md brround cover-image"
                              src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/img/faces/7.jpg`}
                            />
                          </div>
                          <div className="">
                            <div
                        ...
                        <div className="list-group-item d-flex  align-items-center">
                          <div className="me-2">
                            <img
                              alt=""
                              className="avatar avatar-md brround cover-image"
                              src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/img/faces/14.jpg`}
                            />
                            <span className="avatar-status bg-success"></span>
                          </div>
                          <div className="">
                        ...
                        <div className="list-group-item d-flex  align-items-center">
                          <div className="me-2">
                            <img
                              alt=""
                              className="avatar avatar-md brround cover-image"
                              src={`${process.env.NODE_ENV === 'production' ? basePath : ''}/assets/img/faces/15.jpg`}
                            />
                            <span className="avatar-status bg-success"></span>
                          </div>
                          <div className="">
